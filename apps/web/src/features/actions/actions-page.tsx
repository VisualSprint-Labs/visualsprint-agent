  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        {recommendation.status === "pending" ? (
          <>
            <Button size="sm" leftIcon={<CheckCircle2 size={14} strokeWidth={2} />} disabled={isBusy} onClick={onApprove}>
              Approve
            </Button>
            <Button size="sm" variant="secondary" leftIcon={<XCircle size={14} strokeWidth={2} />} disabled={isBusy} onClick={onReject}>
              Reject
            </Button>
          </>
        ) : null}
        {recommendation.status === "approved" ? (
          <Button size="sm" leftIcon={<Zap size={14} strokeWidth={2} />} disabled={isBusy} onClick={onExecute}>
            Execute
          </Button>
        ) : null}
      </div>
